namespace Arian.Quantiq.Infrastructure.Internals;

internal static class SqlReservedWords
{
    public static readonly IReadOnlySet<string> ReservedKeywords = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
    {
        "ADD", "ALL", "ALTER", "AND", "ANY", "AS", "ASC", "AUTHORIZATION", "BACKUP",
        "BEGIN", "BETWEEN", "BREAK", "BROWSE", "BULK", "BY", "CASCADE", "CASE", "CHECK",
        "CHECKPOINT", "CLOSE", "CLUSTERED", "COALESCE", "COLLATE", "COLUMN", "CREATE",
        ...
        "HOLDLOCK", "IDENTITY", "INDEX", "INNER", "INSERT", "INTERSECT", "INTO",
        ...
        "TABLES", "TEXTSIZE", "THEN", "TO", "TOP", "TRAN", "TRANSACTION", "TRIGGER",
